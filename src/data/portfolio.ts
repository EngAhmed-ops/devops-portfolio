...
export const PROJECTS = [
  ...
  title: 'scalable Cloud Architcture',
    image: '',
    description: 'Deployd a Modular and Scalable Virtual Network Architecture with Amazon VPC.',
    technologies: ['AWS', 'cloudwatch', 'EC2', 'S3','Apache Web Server'],
    category: '',
    githubLink: 'https://github.com/EngAhmed-ops/Scalable-VPC-Architecture-',
    websiteLink: '',
  },{
